...
},
{
  ...
  "number": "8.0.25",
  "title": "P22.",
  "body": " P22  A point is called a lattice point if both and are integers.   Find the number of lattice points that are on the line segment connecting the points and .    How many lattice points are on the line segment connecting the points and for arbitrary positive integers and ?     "
},
{
  "id": "problems-27",
  "level": "2",
  ...
  "number": "8.0.26",
  "title": "P23.",
  "body": " P23  In this problem we consider what the Euclidean algorithm might look like if we apply it to an irrational number.   First, show the (simple) calculations to establish that and     Suppose we tried to apply the Euclidean algorithm to the number dividing it by . In this case, we would get Use the two calculations from part 1 to explain how you can obtain the following infinite continued fraction formula for :      "
},
{
  "id": "problems-28",
  "level": "2",
