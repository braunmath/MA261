...
},
{
  ...
  "number": "3.3.5",
  "title": "",
  "body": " Discuss the proof of uniqueness using contradiction through a minimal example. What are the 2-3 key ideas that make this proof work?  "
},
{
...
},
{
  ...
  "number": "8.0.4",
  "title": "P3.",
  "body": " P3   Consider the equation    Draw a picture that demonstrates why this is true for all positive integers . (This is an \"embodied\" proof.)    Give a \"symbolic\" proof of this equation by rewriting the numbers in the sum and using properties of sums that we have discussed in class. Hint: write each odd number as .    Hint: As with the previous problem, begin with small examples. What happens when ? How can you use these examples to guide your thinking about the general case?    "
},
{
  "id": "problems-6",
  "level": "2",
  ...
  "number": "8.0.5",
  "title": "P4.",
  "body": " P4  Use induction to prove that   "
},
{
  "id": "problems-7",
  "level": "2",
